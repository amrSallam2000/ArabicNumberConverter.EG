...
namespace NumericValidation.EG.Models.PhoneNumber
{
    ...
    public class PhoneNumberInfo
    {
        ...
        /// </remarks>
        public string CleanedNumber { get; set; } = string.Empty; // الرقم بعد التنظيف
        ...
        /// </remarks>
        public string Number { get; set; } = string.Empty; // الرقم النهائي (الصيغة المحلية)
        ...
        /// </remarks>
        public string Prefix { get; set; } = string.Empty; // البادئة (4 أرقام)
        ...
        /// </remarks>
        public string Carrier { get; set; } = string.Empty; // الشركة
        ...
        /// </remarks>
        public string ServiceType { get; set; } = string.Empty; // نوع الخدمة (متحرك/قيمة مضافة)
        ...
        public PhoneNumberInfo Clone()
        {
            return new PhoneNumberInfo
            {
                ...
                CleanedNumber = this.CleanedNumber,
                Number = this.Number,
                Prefix = this.Prefix,
