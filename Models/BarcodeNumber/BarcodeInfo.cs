    ...
    public class BarcodeInfo
    {
        ...
        public string WeightInWordsArabic
        {
            get
            {
                ...
                if (kilograms > 0)
                {
                    result.Append(NumberToWordsConverter.ConvertToArabic(kilograms));
                ...
                if (grams > 0)
                {
                    ...
                    result.Append(NumberToWordsConverter.ConvertToArabic(grams));
        ...
        public string WeightInWordsEnglish
        {
            get
            {
                ...
                if (kilograms > 0)
                {
                    result.Append(NumberToWordsConverter.ConvertToEnglish(kilograms));
                ...
                if (grams > 0)
                {
                    ...
                    result.Append(NumberToWordsConverter.ConvertToEnglish(grams));
        ...
        public string PriceInWords => Price > 0
            ? NumberToWordsConverter.Convert(Price, SelectedLanguage, SelectedCurrency, true)
            : string.Empty;

        /// <summary>Price written in Arabic words with selected currency</summary>
        public string PriceInWordsArabic => Price > 0
            ? NumberToWordsConverter.Convert(Price, Language.Arabic, SelectedCurrency, true)
            : string.Empty;

        /// <summary>Price written in English words with selected currency</summary>
        public string PriceInWordsEnglish => Price > 0
            ? NumberToWordsConverter.Convert(Price, Language.English, SelectedCurrency, true)
            : string.Empty;
        ...
        public string UnitPriceInWords => UnitPrice > 0
            ? $"{NumberToWordsConverter.Convert(UnitPrice, SelectedLanguage, SelectedCurrency, true)} لكل كيلو"
            : string.Empty;
        ...
        {
            return NumberToWordsConverter.ConvertWithDetails(Price, SelectedLanguage, SelectedCurrency);
        }
