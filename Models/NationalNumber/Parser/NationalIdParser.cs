...
using NumericValidation.EG.Models.NationalNumber.Info;
using System;
...
namespace NumericValidation.EG.Models.NationalNumber.Parser
{
    /// <summary>
    ...
    public class NationalIdParser
    {
        ...
        public NationalIdInfo Parse(string nationalId)
        {
            ...
            // Clean the number of spaces and dashes
             string cleanedId = CleanNationalId(nationalId);


            // ⭐⭐ Important: Enter your national ID number first
            ...
            try
            {
                ...
                // Date verification with leap year
                ...
                // If we are correcting the days, use the corrected day
                if (_autoCorrectInvalidDays && day != correctedDay)
                {
                    // Record that we have made the correction
                    day = correctedDay;
                }

                // Create a birth date with corrected days if available
